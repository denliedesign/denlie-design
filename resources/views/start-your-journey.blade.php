            ...
            <div class="container py-5">
                <section>
                    <div class="d-md-flex justify-content-center align-items-center">
                        ...
                        <h2 class="open-concept-title text-center ms-3">Build Your Website Bundle</h2>
                    </div>
...
{{--                        <x-package icon="Color_2" item="custom design" cost="5999" description="Our Custom Design is ideal for studios seeking unique designs while embracing user-driven principles. Enjoy the flexibility of tailored aesthetics, ensuring your website stands out in the dance community. This option is also mobile-friendly and includes 10 Pages plus access to dynamic dance photography and illustrations." />--}}
                        ...
                        <x-package icon="Color_1" item="licensed design" cost="2999" description="Our Licensed Design is perfect for studios who desire a proven design crafted with the parents of dancers in mind. We focus on delivering a seamless user experience, tailored to grow the size of your dance family effortlessly.
                        ...
                        <x-package icon="Color_4" item="custom refresh" cost="2099" description="Exclusive deal for existing clients. Enjoy a stunning new look at 65% savings, updating your digital presence with modern designs and features for a fraction of the original cost." />
                        <x-package icon="Color_3" item="licensed refresh" cost="1049" description="Exclusive deal for existing clients. Enjoy a stunning new look at 65% savings, updating your digital presence with modern designs and features for a fraction of the original cost." />
                    </div>
...
{{--                        <x-package icon="Color_7" item="branding" cost="1999" description="Elevate your dance studio's identity with a cohesive branding strategy. From logo design to a consistent visual theme across all digital platforms, we help create a memorable brand that resonates with your audience and stands out in the competitive dance industry." />--}}
                        ...
                        <x-package icon="Color_8" item="SiteMaster CMS" cost="1299" description="SiteMaster CMS offers comprehensive control over your website's content and structure, providing an intuitive platform for managing pages, media, and design elements across your entire site with ease." />
                        <x-package icon="Color_9" item="animation" cost="399" description="Enhance your site's appeal with animated content, including dynamic text and interactive elements, for a more engaging user experience." />
                        <x-package icon="Color_10" item="password page" cost="249" description="Secure sensitive content with a password-protected page. Ideal for sharing exclusive information like recital schedules with dance families, ensuring privacy and access control." />
                        <x-package icon="Color_1" item="additional page" cost="199" description="Add another page to your website. 'Add to Cart' for each extra page you require." />
                        <x-package icon="Color_2" item="additional form" cost="199" description="Add another form to your website. 'Add to Cart' for each extra form you require." />
                    </div>
                    <h2 class="fonts-play ms-3 mt-5">Increase Engagement With Content Modules</h2>
                    <div class="row row-cols-1 row-cols-sm-1 row-cols-md-3 row-cols-lg-3">
                        <x-package icon="Color_3" item="promo feed" cost="399" description="Keep your audience updated with the latest offerings such as dance camps, intensives, mini-sessions, and holiday discounts. This dynamic tool is perfect for highlighting seasonal promotions and masterclasses, ensuring your audience never misses out." />
                        <x-package icon="Color_4" item="blog" cost="399" description="Share your expertise and dance insights through a dedicated blog. It's an effective way to establish authority, connect with your community, and drive more website traffic." />
                        <x-package icon="Color_5" item="newsletter" cost="399" description="Engage directly with dance families by sending out beautifully crafted newsletters. Keep them informed and involved with updates, news, and special offers, enhancing the sense of community around your studio." />
                        <x-package icon="Color_6" item="recital hub" cost="399" description="Simplify recital season for your dance families with a centralized online hub. This dedicated space on your website organizes all things recital-related, from schedules to costumes, making information access straightforward and stress-free." />
                        <x-package icon="Color_7" item="EngagePlus" cost="1279" description="Save 20%. A dynamic content delivery bundle designed to seamlessly integrate the newsletter, blog, promo feed, and recital hub into your website, fostering enhanced audience engagement." />
                    </div>
                </section>
            </div>
        </div>

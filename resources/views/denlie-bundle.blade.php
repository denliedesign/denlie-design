                ...
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-2 row-cols-lg-2">
                    ...
                    <div class="d-flex justify-content-center align-items-center">
                        <div>
                            ...
                            <div><span style="background: #B12729; color: white; padding: 4px 8px; font-weight: 700; font-size: 12px;" class="rounded">$50 off monthly</span>
{{--                                &nbsp;<span style="color: #B12729; font-size: 12px; font-weight: 700;">Limited time deal</span>--}}
                            ...
                            <div style="font-size: 14px;">Lock in Your Savings! Sign up now and enjoy our special rate of just $449/month, down from $499/month. This exclusive offer runs from November 15th to November 30th. Building your site begins immediately upon the start of your subscription, and you can expect it to be complete within 2 months. We will reach out to you shortly after payment to kickstart the process. Secure this discounted rate for 12 months.</div>

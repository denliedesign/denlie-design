        ...
        <div class="card-body">
            ...
            <div class="fonts-robo" style="height: auto; line-height: 1 !important;">
                ...
                <div class="d-flex align-items-center">
                    <p class="fw-bold pb-0 mb-0">${{ $cost }}</p> &nbsp; &nbsp;
                    <button class="btn btn-coral color-warm shadow rounded add-to-cart" data-name="addons[]" data-cost="{{ $cost }}" data-value="{{ str_replace(' ', '_', $item) }}">Add to Cart</button>
                </div>
            </div>
        </div>
    </div>
